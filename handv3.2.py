...
while True:
    ...
    # DISPLAY INFO
    cv2.putText(frame, f"number:{number}", (5,40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100,0,0), 2)
    cv2.putText(frame, f"Last_stable:{last_stable_number}", (5,60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100,0,0), 2)
    cv2.putText(frame, f"Last_display_number:{last_display_number}", (5,80), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100,0,0), 2)
    if current_mode == "DIGIT":
        cv2.putText(frame, f"{last_display_number}", (300,100), cv2.FONT_HERSHEY_SIMPLEX, 3, (100,0,255), 5)
    cv2.putText(frame, f"Calc: {calculation}", (5,100), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,0,255), 2)
    ...
    if result == None:
        cv2.putText(frame, f"{''.join(map(str,calculation))}", (5,350), cv2.FONT_HERSHEY_SIMPLEX, 3, (0,255,0), 5)    
    else:
        cv2.putText(frame, f"{''.join(map(str,calculation))}={result}", (5,350), cv2.FONT_HERSHEY_SIMPLEX, 3, (0,255,0), 5)  
